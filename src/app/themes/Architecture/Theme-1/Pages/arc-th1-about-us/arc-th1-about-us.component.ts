...
@Component({
  selector: 'app-arc-th1-about-us',
  templateUrl: './arc-th1-about-us.component.html',
  styleUrls: ['./arc-th1-about-us.component.scss']
})
export class ArcTh1AboutUsComponent implements OnInit {
  AboutUsHistory: any;
