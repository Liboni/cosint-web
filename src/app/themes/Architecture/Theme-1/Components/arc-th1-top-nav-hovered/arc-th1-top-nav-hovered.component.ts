...
@Component({
  selector: 'app-arc-th1-top-nav-hovered',
  templateUrl: './arc-th1-top-nav-hovered.component.html',
  styleUrls: ['./arc-th1-top-nav-hovered.component.scss']
})
export class ArcTh1TopNavHoveredComponent implements OnChanges {
